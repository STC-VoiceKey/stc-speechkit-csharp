...
namespace Cloud.Client.TTS.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SynthesizeRequest :  IEquatable<SynthesizeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SynthesizeRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SynthesizeRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SynthesizeRequest" /> class.
        /// </summary>
        ...
        public SynthesizeRequest(SynthesizeText Text = default(SynthesizeText), string VoiceName = default(string), string Audio = default(string))
        {
            // to ensure "Text" is required (not null)
            if (Text == null)
            {
                throw new InvalidDataException("Text is a required property for SynthesizeRequest and cannot be null");
            }
            else
            {
                this.Text = Text;
            ...
            if (VoiceName == null)
            {
                throw new InvalidDataException("VoiceName is a required property for SynthesizeRequest and cannot be null");
            }
            else
            {
            ...
            if (Audio == null)
            {
                throw new InvalidDataException("Audio is a required property for SynthesizeRequest and cannot be null");
            }
            else
            {
                this.Audio = Audio;
        ...
        {
            return this.Equals(input as SynthesizeRequest);
        }

        /// <summary>
        /// Returns true if SynthesizeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SynthesizeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SynthesizeRequest input)
        {
            if (input == null)
                return false;
