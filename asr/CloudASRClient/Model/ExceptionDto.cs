...
namespace Cloud.Client.ASR.Model
{
    ...
    public partial class ExceptionDto :  IEquatable<ExceptionDto>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ExceptionDto" /> class.
        /// </summary>
        /// <param name="Reason">Error reason (required).</param>
        /// <param name="Message">Error message.</param>
        public ExceptionDto(string Reason = default(string), string Message = default(string))
        {
            // to ensure "Reason" is required (not null)
            if (Reason == null)
            {
                throw new InvalidDataException("Reason is a required property for ExceptionDto and cannot be null");
            }
            else
            {
                this.Reason = Reason;
